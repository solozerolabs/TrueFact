# TrueFact showcase — the optimistic-UI catch
...
| TrueFact, page read alone | `landed` 10/10 (100%) | ✗ fooled by the ✅ |
| **TrueFact + network** | **`did-not-land`** 10/10 (100%) | ✓ **caught** |
...
```bash
truefact view bench/showcase/optimistic-ui__1.jsonl
```
